	...
	<div class="container">
				...
				<div class="table-responsive">
					...
					<section>
						<table id="tabla_usuarios" class="display table table-striped table-bordered table-responsive" cellspacing="0" width="100%">
							<thead>
								<tr>
									<th class="text-center cursora" width="10%">Matricula</th>
									<th class="text-center cursora" width="10%">Usuario</th>
									<th class="text-center cursora" width="7%">Perfil </th>

									<th class="text-center cursora" width="10%">Sección </th>
									<th class="text-center cursora" width="10%">Grupo </th>
									<th class="text-center cursora" width="10%">Fecha Nac.</th>

									<th class="text-center cursora" width="8%">Dirección</th>
		...
		<div class="row">
			...
			<div class="col-sm-4 col-md-3">
				<a href="/<?php echo $retorno; ?>" class="btn btn-danger btn-block"><i class="glyphicon glyphicon-backward"></i> Regresar</a>
			</div>
